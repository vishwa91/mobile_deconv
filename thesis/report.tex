...
\begin{align*}
x[n]=({\sum_{t}^{n}}{\sum}_{t}^{n}a_x[n]){\times}T^2\\
y[n]=({\sum_{t}^{n}}{\sum}_{t}^{n}a_y[n]){\times}T^2\\
z[n]=({\sum_{t}^{n}}{\sum}_{t}^{n}a_z[n]){\times}T^2
\end{align*}
...
with our kernel is as the initial estimate gives better results. 
\pagebreak
