...
\begin{align*}
x[n]=({\Sigma}_{t}^{n}{\Sigma}_{t}^{n}a_x[n]){\times}T^2\\
y[n]=({\Sigma}_{t}^{n}{\Sigma}_{t}^{n}a_y[n]){\times}T^2\\
z[n]=({\Sigma}_{t}^{n}{\Sigma}_{t}^{n}a_z[n]){\times}T^2
\end{align*}
